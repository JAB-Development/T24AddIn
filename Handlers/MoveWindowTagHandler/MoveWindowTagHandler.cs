...
namespace T24AddIn.Handlers.MoveWindowTagHandler
{
        ...
        public void Execute(UIApplication app)
        {
            ...
            foreach (var doorTag in tagCollector)
            {
                ...
                using (var trans = new Transaction(doc, "Add Tags to Doors in All Views"))
                {
                    ...
                    ElementId taggedElementId = doorTag.GetTaggedElementIds().FirstOrDefault().HostElementId;
                    ...
                    if (doorLocation != null)
                    {
                        ...
                        doorTag.SetLeaderElbow( new Reference(doorElement), midpoint);
                    }
